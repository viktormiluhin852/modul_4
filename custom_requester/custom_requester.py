...
class CustomRequester:
    ...
    @allure.step("send_request {method} {endpoint}")
    def send_request(
        self,
        method: str,
        endpoint: str,
    ...
    @allure.step("update session headers")
    ...
    @allure.step("log request and response")
    def log_request_and_response(self, response: requests.Response) -> None:
        ...
        with allure.step("log request and response"):
            try:
